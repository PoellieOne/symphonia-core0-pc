...
WORKFLOW
1) Confirm understanding of constraints (max 5 bullets).
2) Restate task scope in your own words.
3) If WRITE is requested:
   - Propose a plan.
   - Wait for explicit approval.
   - Execute exactly within scope.
4) Stop after deliverables.

PROMOTION RULE
- All outputs here are DEVELOPMENT ONLY.
- Promotion to staging/cloud is performed manually by Ralph.
